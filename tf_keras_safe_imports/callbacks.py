...
try:
    from tensorflow.keras.callbacks import EarlyStopping, ModelCheckpoint, CSVLogger, TerminateOnNaN, Callback
except ImportError:
    from keras.api._v2.keras.callbacks import EarlyStopping, ModelCheckpoint, CSVLogger, TerminateOnNaN, Callback
